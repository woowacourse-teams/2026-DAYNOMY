...
const todayNews: NewsArticle = {
  ...
  description: '은행주와 건설주에는 단기 호재, 채권은 중립으로 분석됩니다.',
...
export const dummyNews: NewsArticle[] = [
  ...
  },
  {
    ...
    description: '금리 하락 기대가 커질수록 장기 채권과 배당주 점검이 필요합니다.',
    category: 'BOND',
    imageUrl:
  ...
  },
  {
    ...
    description: '환율 방향성은 수출주 실적과 해외 자산 평가액을 함께 확인해야 합니다.',
  ...
  },
  {
    ...
    description: '실적 개선 기대는 있지만 재고와 가격 회복 속도가 핵심 변수입니다.',
    category: 'STOCK',
    imageUrl:
  ...
  },
  {
    ...
    description: '금리와 달러 흐름이 가격에 부담을 줄 수 있어 분할 접근이 필요합니다.',
    category: 'GOLD',
    imageUrl:
  ...
  },
  {
    ...
    description: '정책 금융 확대 여부에 따라 은행주와 건설주의 반응이 갈릴 수 있습니다.',
    category: 'REAL_ESTATE',
    imageUrl:
  ...
  },
  {
    ...
    description: '고위험 자산 비중이 높은 투자자는 달러와 금 흐름을 함께 확인할 필요가 있습니다.',
