...
const todayNews: NewsArticle = {
  ...
  source: '시장 분석 공개',
  body:
    '정부가 부동산 대출 규제 완화 가능성을 검토하고 있다는 뉴스는 주택 시장의 유동성 기대를 자극하는 정책 이벤트로 해석됩니다. 최근 부동산 시장은 지역별로 거래량 회복 속도가 엇갈리고 있고, 고금리 부담과 대출 규제로 인해 실수요자의 매수 여력이 제한돼 있었습니다. 이런 상황에서 대출 문턱이 낮아질 수 있다는 신호가 나오면 시장은 먼저 거래 회복 가능성에 반응합니다. 은행주는 대출 성장 기대가 반영될 수 있고, 건설주는 분양 심리 개선 가능성이 부각될 수 있습니다. 다만 정책이 실제 시행될지, 적용 대상과 한도가 어떻게 정해질지는 아직 불확실합니다.',
}
...
export const dummyNews: NewsArticle[] = [
  {
    ...
    summary:
      '거래량 증가는 부동산 경기 회복 신호로 해석되며 운용사와 대출 영향이 함께 연결됩니다.',
  ...
  },
  {
    ...
    summary:
      '금리 하락 기대가 커질수록 장기 채권과 배당주 점검이 필요합니다.',
  ...
  },
  {
    ...
    summary:
      '환율 방향성은 수출주 실적과 해외 자산 평가액을 함께 확인해야 합니다.',
  ...
  },
  {
    ...
    summary:
      '실적 개선 기대는 있지만 재고와 가격 회복 속도가 핵심 변수입니다.',
    category: 'COMPANY',
    thumbnailUrl:
  ...
  },
  {
    ...
    summary:
      '금리와 달러 흐름이 가격에 부담을 줄 수 있어 분할 접근이 필요합니다.',
    category: 'GOLD',
    thumbnailUrl:
  ...
  },
  {
    ...
    summary:
      '정책 금융 확대 여부에 따라 은행주와 건설주의 반응이 갈릴 수 있습니다.',
    category: 'POLICY',
    thumbnailUrl:
  ...
  },
  {
    ...
    summary:
      '고위험 자산 비중이 높은 투자자는 달러와 금 흐름을 함께 확인할 필요가 있습니다.',
