        ...
        <section className="loan-section">
          ...
          <div className="analysis-stack">
            ...
            <section className="analysis-card">
              ...
              <p>
                <b className="positive-text">긍정적 영향:</b> 주택 거래 회복 기대, 은행 대출 성장 기대,
                건설사 분양 심리 개선, 부동산 관련 ETF·리츠 관심 증가가 나타날 수 있습니다.
              </p>
              <p>
                <b className="negative-text">부정적 영향:</b> 가계부채 우려가 다시 커지면 규제 완화 폭이 제한될 수
                있고, 연체율 상승 또는 금리 변동이 나타나면 금융·부동산 관련 자산의 상승폭이 줄어들 수 있습니다.
              </p>
            </section>
            ...
            <section className="analysis-card muted">
              ...
              <p>
                단기 가능성을 가장 높게 보는 이유는 정책 검토 뉴스가 실제 수치보다 먼저 주가 기대감에 반영되는
                경우가 많기 때문입니다.
              </p>
              <p>
                중기 가능성은 정책의 세부 조건에 달려 있습니다. DSR·LTV 완화 폭이 크고 수도권 거래량이 회복되면
                경기 효과가 유지될 수 있습니다.
              </p>
              <p>
                장기 리스크는 가계부채와 연체율입니다. 대출 증가가 건전성 악화로 이어지면 은행주 효과는 약해지고,
                부동산 정책도 다시 보수적으로 바뀔 수 있습니다.
              </p>
            </section>
          </div>
        </section>
