...
public record AdminNewsPageResponse(
    @Schema(description = "관리자 뉴스 목록") List<AdminNewsListItemResponse> items,
  ...
  public static AdminNewsPageResponse from(Page<AdminNewsListItemResponse> page) {
    return new AdminNewsPageResponse(
        page.getContent(),
        page.getNumber() + 1,
        page.getSize(),
        page.getTotalPages(),
